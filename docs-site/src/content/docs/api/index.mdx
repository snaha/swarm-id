...
| `uploadUnavailableReason`   | `"no-stamp" \| "stamper-failed" \| undefined`   | Why `uploadMode` is `"unavailable"`; absent whenever uploads work. See [Why Uploads Are Unavailable](../subsidised-gateway/#why-uploads-are-unavailable)                                |
