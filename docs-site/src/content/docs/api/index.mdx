...
| `requestOptions.timeout`        | `number`                 | No       | Request timeout in milliseconds. Overrides the client's default (30 s), which bounds the whole upload; a file of a few MB over a testnet or the public gateway needs more, passed in this third argument                                                         |
