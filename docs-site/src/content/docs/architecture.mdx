...
Swarm ID uses an OAuth-style popup authentication flow. Chrome and Firefox work out of the box; Safari requires disabling cross-site tracking prevention due to storage partitioning (ITP). See [#167](https://github.com/snaha/swarm-id/issues/167) for details.
