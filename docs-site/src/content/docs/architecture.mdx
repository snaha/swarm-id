...
Swarm ID uses an OAuth-style popup authentication flow. Chrome and Firefox work out of the box; Safari requires disabling cross-site tracking prevention (ITP).
