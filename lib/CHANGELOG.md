...
* delete the compatibility shims the no-migration policy makes dead ([#688](https://github.com/snaha/swarm-id/issues/688))
* **lib:** the account-bus cleanup items that are still live ([#687](https://github.com/snaha/swarm-id/issues/687))
...
* **lib:** identity-level ACT grantees via a sharing key ([#691](https://github.com/snaha/swarm-id/issues/691)) ([40618df](https://github.com/snaha/swarm-id/commit/40618df1d410742842efd6ba9d49ea7467a75572))
...
* delete the compatibility shims the no-migration policy makes dead ([#688](https://github.com/snaha/swarm-id/issues/688)) ([4e0092b](https://github.com/snaha/swarm-id/commit/4e0092b3146118a0d1ed80aa3e863ca8fceeb6eb)), closes [#662](https://github.com/snaha/swarm-id/issues/662)
* **lib:** the account-bus cleanup items that are still live ([#687](https://github.com/snaha/swarm-id/issues/687)) ([351b642](https://github.com/snaha/swarm-id/commit/351b64218845d5c10139884a40ce38bbf0de18d0)), closes [#590](https://github.com/snaha/swarm-id/issues/590)
