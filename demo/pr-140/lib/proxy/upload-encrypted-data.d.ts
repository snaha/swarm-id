...
import type { Bee, Stamper, UploadOptions } from "@ethersphere/bee-js";
 ...
 */
export declare function uploadEncryptedDataWithSigning(context: UploadContext, data: Uint8Array, encryptionKey?: Uint8Array, options?: UploadOptions, onProgress?: (progress: UploadProgress) => void): Promise<UploadEncryptedDataResult>;
/**
