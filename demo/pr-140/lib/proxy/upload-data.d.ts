 ...
 */
export declare function uploadDataWithSigning(context: UploadContext, data: Uint8Array, options?: UploadOptions, onProgress?: (progress: UploadProgress) => void): Promise<{
    reference: string;
    tagUid?: number;
}>;
