 ...
 *
 * The swap leg is the same on either rail: what differs is only how the xDAI
 * got to the owner address — a plain transfer from Gnosis, or a Relay delivery
 * from anywhere else. See `payment-rail.ts`.
 */
